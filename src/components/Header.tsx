...
export default function Header() {
  ...
  return (
    <header id="top" className="fixed inset-x-0 top-0 z-50">
      {/* Utility bar */}
      <div className="hidden bg-paper text-[0.72rem] text-ink-soft md:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-1.5 lg:px-10">
          <a href="#visit" className="flex items-center gap-1.5 font-semibold text-navy-900 transition-colors hover:text-gold-600">
