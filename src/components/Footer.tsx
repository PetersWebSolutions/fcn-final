          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-10">
              ...
              <div>
                ...
                <div className="mt-4 text-[0.82rem] leading-relaxed text-white/70">
                  <div className="inline-block space-y-3">
                    ...
                    <p className="flex gap-2">
                      ...
                      <span className="leading-relaxed">
                        Room 601, 6/F San Luis Terraces<br />
                        638 T.M. Kalaw Ave, Ermita Manila 1000
                      </span>
                    </p>
                    ...
                    {/* Clinic Hours after email, width = F to Center */}
                    <div className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2">
                      <p className="flex items-center gap-1.5 text-[0.65rem] font-bold uppercase tracking-widest text-gold-400">
                        <Clock className="h-3.5 w-3.5" />
                        Clinic Hours:
                      </p>
                      <div className="mt-1.5 space-y-0.5 text-[0.72rem] leading-[1.35] text-white/80">
                        <p className="flex justify-between gap-3"><span>Mon – Fri</span><span className="font-semibold text-white">8AM – 5PM</span></p>
                        <p className="flex justify-between gap-3"><span>Sat</span><span className="font-semibold text-white">8AM – 4PM</span></p>
                        <p className="flex justify-between gap-3"><span>Sunday</span><span className="font-semibold text-gold-300">Closed</span></p>
                      </div>
                    </div>
                  </div>
                </div>
